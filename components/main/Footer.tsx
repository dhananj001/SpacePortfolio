                    ...
                    <div>
                        ...
                        <div className="mt-6">
                            ...
                            <div className="flex gap-2">
                                ...
                                />
                                <button className="px-4 py-2 bg-gradient-to-r from-purple-500 to-cyan-500 text-white rounded-lg text-sm font-semibold hover:scale-105 transition-transform">
                                    Join
                                </button>
                            </div>
                        </div>
